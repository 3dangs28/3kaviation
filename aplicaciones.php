<?php include("inc/librerias.php"); ?>
  ...
  <?php include("modalAplicaciones/modal_agregar.php");?>
  <?php include("modalAplicaciones/modal_modificar.php");?>
  <?php include("modalAplicaciones/modal_eliminar.php");?>
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Listado de aplicaciones</h3>
            </div>
            <!-- /.card-header -->
