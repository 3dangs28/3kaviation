<?php include("inc/librerias.php"); ?>
  ...
  <?php include("modalAeronave/modal_agregar.php");?>
  <?php include("modalAeronave/modal_modificar.php");?>
	<?php include("modalAeronave/modal_eliminar.php");?>
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Listado de Aeronaves</h3>
            </div>
            <!-- /.card-header -->
